...
var kha__$Assets_BlobList = function() {
	...
	this.scene_jsonDescription = { name : "scene_json", file_sizes : [1729], files : ["scene.json"], type : "blob"};
...
var kha__$Assets_FontList = function() {
	this.names = ["font"];
	this.fontDescription = { name : "font", file_sizes : [96932], files : ["font.ttf"], type : "font"};
	this.fontName = "font";
	this.font = null;
};
...
kha_LoaderImpl.loadImageFromDescription = function(desc,done,failed) {
	...
	if(StringTools.endsWith(desc.files[0],".hdr")) {
		...
		img.onerror = function(event) {
			failed({ url : desc.files[0], error : event.error});
		};
...
var rice2d_App = function(name,width,height,clearColor,windowMode,scene) {
	if(windowMode == null) {
		windowMode = 0;
	}
	if(clearColor == null) {
...
var rice2d_Debug = function() { };
$hxClasses["rice2d.Debug"] = rice2d_Debug;
rice2d_Debug.__name__ = true;
var rice2d_Scene = function() { };
$hxClasses["rice2d.Scene"] = rice2d_Scene;
...
$hxClasses["rice2d.Script"] = rice2d_Script;
...
var rice2d_files_Path = function() { };
$hxClasses["rice2d.files.Path"] = rice2d_files_Path;
...
var rice2d_node_Logic = function() { };
$hxClasses["rice2d.node.Logic"] = rice2d_node_Logic;
...
var rice2d_node_LogicNode = function(tree) {
	this.outputs = [];
	this.inputs = [];
	this.tree = tree;
};
$hxClasses["rice2d.node.LogicNode"] = rice2d_node_LogicNode;
...
var rice2d_node_LogicNodeInput = function(node,from) {
	this.node = node;
	this.from = from;
};
$hxClasses["rice2d.node.LogicNodeInput"] = rice2d_node_LogicNodeInput;
...
var rice2d_node_LogicTree = function() {
	this.paused = false;
	this.loopBreak = false;
	rice2d_Script.call(this);
};
$hxClasses["rice2d.node.LogicTree"] = rice2d_node_LogicTree;
...
var rice2d_object_Animation = function(indices,speeddiv) {
	this.indices = indices;
	this.index = 0;
	this.speeddiv = speeddiv;
};
$hxClasses["rice2d.object.Animation"] = rice2d_object_Animation;
...
var rice2d_object_Object = function() {
	this.selected = false;
	this.visibile = true;
	this.scripts = [];
...
$hxClasses["rice2d.object.Object"] = rice2d_object_Object;
...
var rice2d_object_Transform = function() {
};
$hxClasses["rice2d.object.Transform"] = rice2d_object_Transform;
...
var rice2d_shaders_Shader = function(shaderData) {
	this.textureUnits = [];
...
$hxClasses["rice2d.shaders.Shader"] = rice2d_shaders_Shader;
...
var rice2d_system_Camera = function() {
	this.active = false;
	this.transform = new kha_math_FastMatrix3(1,0,0,0,1,0,0,0,1);
};
$hxClasses["rice2d.system.Camera"] = rice2d_system_Camera;
...
var rice2d_system_Input = function() { };
$hxClasses["rice2d.system.Input"] = rice2d_system_Input;
...
var rice2d_system_Mouse = function() {
	this.lastY = -1.0;
	this.lastX = -1.0;
	this.wheelDelta = 0;
	this.movementY = 0.0;
...
$hxClasses["rice2d.system.Mouse"] = rice2d_system_Mouse;
...
var rice2d_system_Keyboard = function() {
	this.keyFrame = [];
...
$hxClasses["rice2d.system.Keyboard"] = rice2d_system_Keyboard;
...
var rice2d_ui_Style = function() { };
$hxClasses["rice2d.ui.Style"] = rice2d_ui_Style;
rice2d_ui_Style.__name__ = true;
var rice2d_ui_UI = function(canvasData) {
...
$hxClasses["rice2d.ui.UI"] = rice2d_ui_UI;
...
var scripts_BallController = function() {
	this.diry = 0.0;
	this.dirx = 0.0;
	var _gthis = this;
	rice2d_Script.call(this);
	...
	this.notifyOnUpdate(function() {
		...
		_gthis.object.props.x += _gthis.dirx * 6;
		var _gthis1 = _gthis.object.props;
		_gthis1.y += _gthis.diry * 6;
		return _gthis1.y;
	});
...
$hxClasses["scripts.BallController"] = scripts_BallController;
...
var scripts_PaddleController = function() {
	this.speed = 4;
...
$hxClasses["scripts.PaddleController"] = scripts_PaddleController;
...
var scripts_Scoreborad = function() {
	var _gthis = this;
	rice2d_Script.call(this);
	this.notifyOnAdd(function() {
...
$hxClasses["scripts.Scoreborad"] = scripts_Scoreborad;
...
$hxClasses["scripts.Walls"] = scripts_Walls;
