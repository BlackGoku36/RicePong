...
vertex painter_video_vert_main_out painter_video_vert_main(painter_video_vert_main_in in [[stage_in]], constant painter_video_vert_main_uniforms& uniforms [[buffer(1)]], uint gl_VertexID [[vertex_id]], uint gl_InstanceID [[instance_id]])
{
